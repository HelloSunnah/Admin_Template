<template>
      <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium icon css-vubbuv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" fill="white" data-testid="VaccinesIcon" width="32" height="32">
